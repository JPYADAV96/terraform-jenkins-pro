module "networking" {
  source               = "../terraform-jenkins-pro/networking"
...
module "security_group" {
  source              = "../terraform-jenkins-pro/security-groups"
...
module "jenkins" {
  source                    = "../terraform-jenkins-pro/jenkins"
...
module "lb_target_group" {
  source                   = "../terraform-jenkins-pro/load-balancer-target-group"
...
module "alb" {
  source                    = "../terraform-jenkins-pro/load-balancer"
...
module "hosted_zone" {
  source          = "../terraform-jenkins-pro/hosted-zone"
  domain_name     = "jenkins.rishikanaujia.com"
  aws_lb_dns_name = module.alb.aws_lb_dns_name
  aws_lb_zone_id  = module.alb.aws_lb_zone_id
}

module "aws_ceritification_manager" {
  source         = "../terraform-jenkins-pro/certificate-manager"
  domain_name    = "jenkins.rishikanaujia.com"
